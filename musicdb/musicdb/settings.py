...
dotenv.load_dotenv(os.path.join(os.path.dirname(BASE_DIR), 'auth', 'creds.env'))
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'musicdb', 'static')

MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'musicdb', 'uploads')
